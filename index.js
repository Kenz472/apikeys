...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'Database', 'index.html'));
});
...
app.use((req, res, next) => {
    ...
    res.status(404).sendFile(process.cwd() + "/Database/404.html");
});
...
app.use((err, req, res, next) => {
    ...
    res.status(500).sendFile(process.cwd() + "/Database/500.html");
});
